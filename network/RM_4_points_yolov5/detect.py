...
def show_results(img, xyxy, conf, landmarks, class_num):
    ...
    label = str(conf)[:5]
    font_scale = tl / 3 
    cv2.putText(img, "class:"+str(class_num), (x1+50, y1 - 2), 0, font_scale, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
    cv2.putText(img, label, (x1, y1 - 2), 0, font_scale, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
    return img
